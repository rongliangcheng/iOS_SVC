...
class LoginWithWrongUsername extends EndpointSystemTestSpec{
...
//        }
    ...
    def "Login the hjt System"(){
        ...
        UICommon.userLoginCloud(driver,"test","rongliang")

        log.info("A toast will appear when input the wrong username/password")
